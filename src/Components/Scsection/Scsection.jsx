...
export default function Scsection({cardtitle,li1,li2,li3,li4,li5,li6,li7,li8,li9,li10,li11,li12}) {
  return (
    <div>
        ...
        <div className="row">
          ...
          <div className="service-list p-2 p-lg-3">
            <ul className="orgdisc-list m-0 row">
                ...
                <li className="col-12 col-md-6  ps-0 list-unstyled btn">{li12} </li>
            </ul>
          </div>
              </div>
            </div>
